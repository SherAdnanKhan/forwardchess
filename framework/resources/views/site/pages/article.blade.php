      ...
      <div class="col-lg-12">
        <ul class="breadcrumb-block d-flex p-t-105 p-b-30">
          <li class="breadcrumb-item d-flex align-items-center m-r-10">
            <a class="description" href="{{ route('site.articles.index') }}">Browse Blog</a>
          ...
          <li class="breadcrumb-item d-flex align-items-center">
            <a class="secondary-description">{{ $article->title }}</a>
          </li>
        </ul>
        <div class="breadcrumb-link">
          <a class="back-link d-flex align-items-center m-t-45 m-b-30" href="{{ route('site.articles.index') }}">
            <svg class="m-r-10 m-b-2" width="12" height="12" viewBox="0 0 12 12" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
              <path
                d="M12 5.24267V6.75782H2.90909L7.07576 10.9245L6 12.0002L0 6.00024L6 0.000244141L7.07576 1.076L2.90909 5.24267H12Z"
                fill="#F96F34"/>
            </svg>
            Back
          </a>
        ...
        <div class="row no-margin">
          <div class="col-12 no-padding">
            <div class="wishlist-btn-wrapper">
              <div class="col-lg-12">
                <div class="title m-r-40">{{ $article->title }}</div>
                {!! $article->content !!}
              </div>
            </div>
          </div>
